...
export const TicketList: React.FC = () => {
    ...
    const getStatusIcon = (status: TicketStatus) => {
        switch (status) {
            case TicketStatus.CLOSED: return <CheckCircle2 className="w-5 h-5 text-green-500" />;
            case TicketStatus.IN_PROGRESS: return <Clock className="w-5 h-5 text-yellow-500" />;
    ...
    const getStatusStyle = (status: TicketStatus) => {
        switch (status) {
            case TicketStatus.CLOSED: return 'bg-green-500/10 text-green-400 border-green-500/20';
                        ...
                        <div className="flex justify-between items-start">
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-xs font-medium border flex items-center gap-1.5 ${getStatusStyle(ticket.status)}`}>
